...
public class SocialNetworkTests {
	...
	public void RegVal() {
		...
		PO_RegisterView.fillForm(driver, "Pocito", "pocito32@gmail.com", "pocito123", "pocito123");
	...
	public void RegInval() {
		...
		elementos.get(0).click();
		// Rellenamos el formulario.
		PO_RegisterView.fillForm(driver, "Pocito", "pocito32@gmail.com", "pocito1234", "pocito123");
		// Comprobamos que se ha registrado con éxito
	...
	public void InvVal() {
		...
		// COmprobamos que entramos en la pagina privada
		SeleniumUtils.textoPresentePagina(driver, "Usuarios");
		By enlace = By.xpath("//td[contains(text(), 'Prueba2')]/following-sibling::*[2]");
	...
	public void ListAmiVal() {
		...
		elementos.get(0).click();
		elementos = PO_View.checkElement(driver, "free", "//td[contains(text(), 'Prueba1')]");
		assertTrue(elementos.size() == 1);
	}
